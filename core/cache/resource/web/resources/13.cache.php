<?php  return array (
  ...
  array (
    ...
    '_content' => '{insert \'file:templates/shop.tpl\'} ',
    '_isForward' => false,
    '_sjscripts' => 
    array (
	...
	<script type="text/javascript">
		...
		mse2FormConfig["f6450d56534be913e4a2337482f88a62e791947c"] = {"autocomplete":"results","queryVar":"query","minQuery":3,"pageId":13};
	</script>',
      4 => '<link rel="next" href="katalog/elektroinstrument/gajkovertyi/?page=2"/>',
    ),
    '_jscripts' => 
    array (
	...
	<script type="text/javascript">
      ...
      '<link rel="next" href="katalog/elektroinstrument/gajkovertyi/?page=2"/>' => true,
    ),
  ),
  'contentType' => 
  array (
...
<li class="active">Гайковерты</li></ul>',
    '[[pdoMenu?showLog=``&fastMode=``&level=`0`&parents=`4`&displayStart=``&resources=``&templates=``&context=``&cache=`1`&cacheTime=`3600`&cacheAnonymous=``&plPrefix=`wf.`&showHidden=``&showUnpublished=``&showDeleted=``&previewUnpublished=``&hideSubMenus=``&useWeblinkUrl=`1`&sortdir=`ASC`&sortby=`menuindex`&limit=`0`&offset=`0`&rowIdPrefix=``&firstClass=`first`&lastClass=`last`&hereClass=`active`&parentClass=``&rowClass=``&outerClass=``&innerClass=``&levelClass=``&selfClass=``&webLinkClass=``&tplOuter=`@INLINE <ul id="categories">{$wrapper}</ul>`&tpl=`@INLINE <li><a href="{$link}" {$classes}>{$menutitle}  <span>({$children})</span></a>{$wrapper}</li>`&tplParentRow=``&tplParentRowHere=``&tplHere=``&tplInner=`@INLINE [[*id:is=`[[+id]]`:then=`<ul style="display:block;">{$wrapper}</ul>`:else=`<ul>{$wrapper}</ul>`]]`&tplInnerRow=``&tplInnerHere=``&tplParentRowActive=``&tplCategoryFolder=``&tplStart=`@INLINE <h2[[+classes]]>[[+menutitle]]</h2>[[+wrapper]]`&checkPermissions=``&hereId=``&where=``&select=``&scheme=``&toPlaceholder=``&countChildren=`1`]]' => '<ul id="categories"><li><a href="katalog/elektroinstrument/"  class="first active">Электроинструмент  <span>(202)</span></a><ul><li><a href="katalog/elektroinstrument/dreli/"  class="first">Дрели  <span>(133)</span></a></li><li><a href="katalog/elektroinstrument/shurupovertyi/" >Шуруповерты  <span>(16)</span></a></li><li><a href="katalog/elektroinstrument/gajkovertyi/"  class="active">Гайковерты  <span>(16)</span></a></li><li><a href="katalog/elektroinstrument/pilyi/" >Пилы  <span>(4)</span></a><ul><li><a href="katalog/elektroinstrument/pilyi/torczovochnyie-pilyi/"  class="first">Торцовочные пилы  <span>(0)</span></a></li><li><a href="katalog/elektroinstrument/pilyi/czirkulyarnyie-ruchnyie-pilyi/" >Циркулярные ручные пилы  <span>(0)</span></a></li><li><a href="katalog/elektroinstrument/pilyi/sabelnyie-i-stolyarnyie-pilyi/" >Сабельные и столярные пилы  <span>(0)</span></a></li><li><a href="katalog/elektroinstrument/pilyi/lobzikovyie-pilyi/"  class="last">Лобзиковые пилы  <span>(0)</span></a></li></ul></li><li><a href="katalog/elektroinstrument/shtroborezyi-(borozdodelyi)/" >Штроборезы (бороздоделы)  <span>(1)</span></a></li><li><a href="katalog/elektroinstrument/mikseryi-stroitelnyie/" >Миксеры строительные  <span>(2)</span></a></li><li><a href="katalog/elektroinstrument/perforatoryi/"  class="last">Перфораторы  <span>(8)</span></a></li></ul></li><li><a href="katalog/svarochnoe-oborudovanie/"  class="last">Сварочное оборудование  <span>(6)</span></a><ul><li><a href="katalog/svarochnoe-oborudovanie/apparatyi-dlya-ruchnoj-svarki-pokryityim-elektrodom-(mma)/"  class="first">Аппараты для ручной сварки покрытым электродом (MMA)  <span>(2)</span></a><ul><li><a href="katalog/svarochnoe-oborudovanie/apparatyi-dlya-ruchnoj-svarki-pokryityim-elektrodom-(mma)/transformatoryi-i-vyipryamiteli-svarochnyie/"  class="first">Трансформаторы и выпрямители сварочные  <span>(0)</span></a></li><li><a href="katalog/svarochnoe-oborudovanie/apparatyi-dlya-ruchnoj-svarki-pokryityim-elektrodom-(mma)/invertoryi-svarochnyie/"  class="last">Инверторы сварочные  <span>(0)</span></a></li></ul></li><li><a href="katalog/svarochnoe-oborudovanie/apparatyi-dlya-plazmennoj-rezki/" >Аппараты для плазменной резки  <span>(0)</span></a></li><li><a href="katalog/svarochnoe-oborudovanie/apparatyi-dlya-poluavtomaticheskoj-svarki/" >Аппараты для полуавтоматической сварки  <span>(0)</span></a></li><li><a href="katalog/svarochnoe-oborudovanie/apparatyi-dlya-svarki-neplavyashhimsya-elektrodom-(tig)/"  class="last">Аппараты для сварки неплавящимся электродом (TIG)  <span>(0)</span></a></li></ul></li></ul>',
