<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Главная',
    'longtitle' => 'Магазин инструментов для строительства и ремонта в Витебске, в Беларуси',
    'description' => '',
    'alias' => 'index',
    'link_attributes' => '',
    'published' => 1,
...
<p>To learn more about MODX, be sure to check out the <a href="https://rtfm.modx.com/revolution/2.x/getting-started">Getting Started</a> section in the official documentation.</p>',
    ...
    array (
      0 => 'sliderhome',
      1 => '[{"MIGX_id":"1","alt":"Качество и надежность","description":"Призван работать сутками без перебоя","url":"/katalog","color":"","xposition":"145","slstyle":"zoomout","image":"assets/images/slider-1.jpg"},{"MIGX_id":"2","alt":"Точность","description":"Ювелирная точность и скорость работы","url":"","color":"","xposition":"","slstyle":"","image":"assets/images/slider-2.jpg"},{"MIGX_id":"3","alt":"Безопасность","description":"Повышенная безопасность инструментов","url":"","color":"","xposition":"","slstyle":"","image":"assets/images/slider-3.jpg"}]',
      2 => 'default',
      3 => NULL,
      4 => 'migx',
    ),
    ...
    '_content' => '{insert \'file:templates/home.tpl\'}',
    '_isForward' => false,
    '_sjscripts' => 
    array (
	...
	<script type="text/javascript">
		...
		mse2FormConfig["53af125a25be3eabc7eb7b1fe0002d846bf09b47"] = {"autocomplete":"results","queryVar":"query","minQuery":3,"pageId":1};
	</script>',
    ),
    '_jscripts' => 
    array (
  ...
  array (
    ...
    '[[pdoMenu?showLog=``&fastMode=``&level=`2`&parents=`0`&displayStart=``&resources=``&templates=``&context=``&cache=``&cacheTime=`3600`&cacheAnonymous=``&plPrefix=`wf.`&showHidden=``&showUnpublished=``&showDeleted=``&previewUnpublished=``&hideSubMenus=``&useWeblinkUrl=`1`&sortdir=`ASC`&sortby=`menuindex`&limit=`0`&offset=`0`&rowIdPrefix=``&firstClass=`homepage`&lastClass=`last`&hereClass=`current`&parentClass=``&rowClass=``&outerClass=``&innerClass=``&levelClass=``&selfClass=``&webLinkClass=``&tplOuter=`@INLINE <ul class="menu" id="responsive">{$wrapper}</ul>`&tpl=`@INLINE <li[[+classes]]><a href="[[+link]]" [[+attributes]]>[[+menutitle]]</a>[[+wrapper]]</li>`&tplParentRow=`@INLINE <li><a href="{$link}">{$menutitle}</a><div class="mega">
						<div class="mega-container">{$wrapper}</div></div><li>`&tplParentRowHere=``&tplHere=``&tplInner=`@FILE chunks/innerHeadMenu.tpl`&tplInnerRow=`<li><a href="{$link}">{$menutitle}</a>{$wrapper}</li>`&tplInnerHere=``&tplParentRowActive=``&tplCategoryFolder=``&tplStart=`@INLINE <h2[[+classes]]>[[+menutitle]]</h2>[[+wrapper]]`&checkPermissions=``&hereId=``&where=``&select=``&scheme=``&toPlaceholder=``&countChildren=``]]' => '<ul class="menu" id="responsive"><li class="homepage current"><a href="/" >Главная</a></li><li><a href="katalog/">Каталог</a><div class="mega">
...
if (!empty($toPlaceholder)) {
	...
	"fields": [{
		...
		"caption": "Color",
		"inputTVtype": "option",
		"inputOptionValues": "Dark==dark||White=="
	}, {
		"field": "xposition",
		"caption": "X-position",
		"inputTVtype": "option",
		"inputOptionValues": "Right==145||Left==750"
	}, {
		"field": "slstyle",
		"caption": "Sliderstyle",
		"inputTVtype": "option",
		"inputOptionValues": "Fadeout==fade||Zoomout==zoomout||Fadetotop==fadetotopfadefrombottom"
	}, {
		"field": "image",
		"caption": "Image",
		"inputTVtype": "image"
