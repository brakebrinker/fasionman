...
require_once(dirname(dirname(__FILE__)) . '/lib/PHPExcel/PHPExcel.php');
require_once(dirname(dirname(__FILE__)) . '/lib/PHPExcel/PHPExcel/IOFactory.php');
    ...
    public function read(array $provider, $callback = null)
    {
        ...
        try {
            if ($this->initPHPExcel()) {
                ...
                //$sheetsIterator = $this->objPHPExcel->getWorksheetIterator();
    ...
    private function initPHPExcel()
    {
        if (!$this->objPHPExcel) {
            ...
            try {
                ...
                $inputFileType = PHPExcel_IOFactory::identify($this->provider['file']);
